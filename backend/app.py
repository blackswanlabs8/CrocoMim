...
# Built-in SMTP defaults keep feedback delivery working even if no environment
# variables or local env file are provided (e.g., during first-time deploys).
DEFAULT_SMTP = {
    "SMTP_HOST": "smtp.crocomim.ru",
    "SMTP_PORT": "587",
    "SMTP_USERNAME": "hi@crocomim.ru",
    "SMTP_PASSWORD": "@llig@toR",
    "FEEDBACK_RECIPIENT": "hi@crocomim.ru",
    "FEEDBACK_SENDER": "hi@crocomim.ru",
    "SMTP_STARTTLS": "true",
}
...
# Apply built-in defaults only after the optional local env file so that real
# environment variables and config/smtp.env always take precedence.
for _key, _value in DEFAULT_SMTP.items():
